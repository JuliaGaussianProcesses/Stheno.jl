using AbstractGPs,
    AbstractGPsMakie, CairoMakie, KernelFunctions, LinearAlgebra, Random, Stheno
...
x2 = randn(rng, 4);
x3 = randn(rng, 7);
x = BlockData(GPPPInput(:g1, x1), GPPPInput(:g2, x2), GPPPInput(:g3, x3));
...
set_theme!(; palette=(color=Set1_4,), patchcolor=(Set1_4[2], 0.2))
