...
function block_arrays_from_vector_of_vectors()
...
function block_arrays_from_matrix_of_matrices()
...
function block_array_squarediagonal_construction()
...
function block_array_chol_logdet_backsolving()
    rng, P1, P2 = MersenneTwister(123456), 3, 4
...
function block_arrays_uniform_scaling_interactions()
...
function run_block_arrays_tests()
    ...
    block_arrays_mv_mul()
    block_array_mm_mul()
    block_array_squarediagonal_construction()
    block_array_chol_logdet_backsolving()
    block_arrays_uniform_scaling_interactions()
    block_arrays_cov_mat()
end
